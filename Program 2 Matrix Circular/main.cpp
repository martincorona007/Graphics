...
int matrix_1[20][20];
float matrix_2[20][20];

int n,m,number,aux_i,aux_j,aux_i1,aux_j1,aux_i2,aux_j2,sum=0,sum1=0,size,rule_1=0,op,d1,d2;
    ...
    if(flag_1==true){
        ...
        printf("\nMatrix 2");
            ...
            for(int i=0;i<n;i++){//FIND THE NUMBER AND VERIFY IF EXITS
                ...
                if(sect_a==1||sect_b==1||sect_c==1||sect_d==1||sect_e==1||sect_f==1||sect_g==1||sect_h==1||sect_i==1){//CLEAN DATA
                aux_j=0;
                aux_i=0;
               printf("\nPOINT20 [%i,%i] + [%i,%i] %i %i ",aux_i1,aux_j1,aux_i2,aux_j2,aux_i,aux_j);
